...
const AdminHome = () => {
    ...
    // PIChart code end here

    return (
        <div>
            <h1 className='text-3xl font-bold mb-4 text-white text-center'>Welcome Back, <span className='text-orange-500'>{user?.displayName}</span></h1>

            <div className="stats shadow flex mx-20">
